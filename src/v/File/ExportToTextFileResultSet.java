...
/**
 * Class to Write the data in a ResultSetTableModel to a text file.
 ...
 * It is assumed that the ResultSet within the ResultSetTableModel is at row beforeFirst.
 * This is necessary in order to accommodate databases like SQLite that are TYPE_FORWARD_ONLY.
 * <p>Title: ExportToTextFileResultSet<p>
 ...
 * @version 4.0
 */
public class ExportToTextFileResultSet
{
RandomAccessFile raf;
ResultSetTableModel rstmToFile;
String fileName;
boolean flag = false;
String fileName1 = "";
...
/**
  ...
  * @param 
  */
public ExportToTextFileResultSet(ResultSetTableModel tm, String[] params)
    {
 ...
 */
public ExportToTextFileResultSet(ResultSetTableModel tm, String[] params, String basename, String windowTitle) 
  {
 ...
 * @param hiddenColumns 
 */
public ExportToTextFileResultSet(ResultSetTableModel rstm, String[] params, String destAbsPathFileName, String[] hiddenColumns, boolean abs, String bn, String windowTitle)
  {
...
private String saveFileDialog(Frame f, String title, String defDir, String basename)
   ...
   * @return boolean
   */
public boolean writeToFileRSTM(ResultSetTableModel tmLoc, String filename)
  {
...
private boolean writeToFileRSTM()
  ...
  */
  try
    ...
    // Column numbers begin at "1" in ResultSetTableModel.MetaData.  However, in ResultSetTableModel.columnNames[] they begin at 0
    ...
    for (int i = 0; i < rows; i++)  // for each row in data
      {
      str = "";
      this.rstmToFile.rsl.next(); // Moves the cursor forward one row from its current position. A ResultSet cursor is initially positioned before the first row; the first call to the method next makes the first row the current row.
